...
typedef enum logic [1:0] {OP_PRE  =2'b00,
						  OP_ACT  =2'b01,
						  OP_RD   =2'b10,
						  OP_WR   =2'b11} B2X_Command;  
...
typedef enum logic[3:0] {SDR_MODE		=4'b0000,
						 SDR_REFRESH 	=4'b0001,
						 SDR_PRECHARGE	=4'b0010,
						 SDR_ACTIVATE	=4'b0011,
						 SDR_WRITE		=4'b0100,
						 SDR_READ		=4'b0101,
						 SDR_BT			=4'b0110,
						 SDR_NOOP		=4'b0111,
						 SDR_DESEL		=4'b1111} SDRAM_Commands;

SDRAM_Commands mgmt_cmd;						 
